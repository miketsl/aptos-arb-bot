...
impl RecordingStats {
    ...
    pub fn record_batch_processed(
        ...
        self.avg_batch_processing_ms = (self.avg_batch_processing_ms * (total_batches - 1.0)
    ...
    pub fn format_summary(&self) -> String {
        ...
        format!(
            ...
            if self.min_batch_processing_ms == u64::MAX {
                0
            } else {
                ...
                loop {
                    ...
                    if total_operations > 0 {
                        ...
                        if error_rate > 0.1 {
                            ...
                            warn!(
                                "Health check: High error rate detected: {:.2}% ({}/{})",
                                error_rate * 100.0,
                                total_errors,
                                total_operations
                            );
